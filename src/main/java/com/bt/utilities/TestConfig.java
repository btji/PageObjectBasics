package com.bt.utilities;
public class TestConfig{


	
	public static String server="smtp.gmail.com";
	public static String from = "lawlessbt@gmail.com";
	public static String password = "mahima89";
	public static String[] to ={"brijeshtripathi010@gmail.com","brijeshtripathi010@ghotmail.com"};
